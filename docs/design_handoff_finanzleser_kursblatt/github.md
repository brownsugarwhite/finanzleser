...
- Kursblatt Seite 3–4: Festgeldvergleich mit Zinskurve je Laufzeit, Ertrag/Inflation-Kennzahlen, Sortierung nach Ertrag; Eingabe-Bausteine Setzzeile (Eingabefeld) und Register (Dropdown) als eigene DCs
- Handoff-Paket `design_handoff_finanzleser_kursblatt/` (README als Statement of Work)

## Sync history
### 2026-09-15T14:52:03Z
- Neues Kursblatt-Design für Vergleiche (Autokredit) und Rechner (Kredit) auf 728-px-Fadenbreite: Lineal-Eingabe (FL Lineal.dc.html), Zinsband mit Bestwert-Faden, Zählwerk-Kennzahlen, Gewinner-Rahmen, Merkzettel
- Rechner-Mechaniken: Drehring (Laufzeit), Ziffern-Zählwerk (Zins), Stempel-Presets, live rollende Rate, Restschuldkurve mit Scrubber, Brücke zum Vergleich
- Gelesen: VergleichEmbed.tsx, vergleich-data route, vergleiche/[slug]/page.tsx, vergleichDescriptions.ts, KreditRechner.tsx, RechnerEmbed.tsx
### 2026-09-09T14:05:33Z
...
| Finanzleser Vergleich & Rechner – Kursblatt.dc.html (+ FL Lineal.dc.html) | components/vergleich/VergleichEmbed.tsx, app/api/vergleich-data/[slug]/route.ts, app/finanztools/vergleiche/[slug]/page.tsx, lib/vergleichDescriptions.ts, components/rechner/KreditRechner.tsx, components/rechner/RechnerEmbed.tsx, components/rechner/ui/* |
| Finanzleser Festgeld & Eingaben – Kursblatt.dc.html (+ FL Setzzeile.dc.html, FL Register.dc.html) | components/vergleich/VergleichEmbed.tsx, app/api/vergleich-data/[slug]/route.ts (festgeldvergleich), components/rechner/ui/RechnerInput.tsx, components/rechner/ui/RechnerSelect (Register-Ersatz), components/rechner/BruttoNettoRechner.tsx |
