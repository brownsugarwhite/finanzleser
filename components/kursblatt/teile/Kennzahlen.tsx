 ...
 * „… Festgeld & Eingaben“:90-94. Die dritte steht groß und nimmt im schmalen Satz die
 * volle Breite.
 */
...
function Eine({ k }: { k: KennzahlWert }) {
  ...
  return (
    <div className="kb-kennzahl" data-gross={k.gross ? "an" : undefined} data-ton={k.ton}>
...
export default function Kennzahlen({ werte }: { werte: KennzahlWert[] }) {
  ...
  return (
    <div className="kb-kennzahlen kb__doppellinie">
