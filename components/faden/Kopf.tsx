        ...
        <div className="kopf__innen">
          <div className="kopf__zeile">
            ...
            <div className="lesezeichen" aria-label="Lesezeichen">
              <button type="button" className="knopf--menue" onClick={onMenue} aria-label="Menü"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round"><path d="M4 7h16M4 12h16M4 17h16" /></svg></button>
              <button type="button" className="lz-wort" onClick={zumWochenbrief} title="Newsletter: donnerstags, ein Feld, kein Formular">Newsletter</button>
