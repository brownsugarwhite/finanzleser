  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <svg style={{ flex: 1, minWidth: 0, height: "1px", display: "block", overflow: "visible" }}>
          <line
            x1="0"
            y1="0"
            x2="100%"
