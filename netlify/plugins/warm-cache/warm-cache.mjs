...
const CURATED_HUBS = new Set([
  ...
  // Achtung: die Route heisst /finanztools/rechner (siehe app/sitemap.ts). Hier stand
  // "/finanztools/rechner-uebersicht" — ein Pfad, den die Sitemap gar nicht enthaelt.
  // Folge: die tatsaechliche Rechner-Uebersicht wurde nie vorgewaermt.
  "/finanztools/rechner",
